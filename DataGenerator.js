...
function generateData(){
    ...
    fs.writeFileSync('./data/employees.json', PreparedEmployeesJson, { recursive: true });
    console.log("Generated employees were save to json file")


    //console.log(EmployeesPreparedJson); 
